...
from api_valor_do_metro_quadrado.tests.helpers import get_client, mock_database_env_vars, mock_async_function_result
...
def test_get_metro_quadrado_success_content(mock_database_env_vars):
    ...
    with mock.patch("api_valor_do_metro_quadrado.infrastructure.repositories.metro_quadrado.MetroQuadradoRepository.get") as mock_repo_get:
        mock_repo_get.return_value = mock_async_function_result(
            {'id': '1', 'valor': 100.0, 'data_de_cadastro': datetime.now()}
        )
